...
$next=  filter_input(INPUT_POST, 'next');
       ...
       if(isset($next)) 
       {
           ...
           $sql="Insert into resulttable values(". $anime1. ",'".$anime1name."',".$anime2.",'". $anime2name."','". $select_value."',". $ts.",". $uid.");";
           mysql_query($sql) or die(mysql_error());
       }
        else if(isset($skip)){
            header('LOCATION:anim1.php');
            exit();
        }
        ?>
<HTML>
...
<nav class="menu">
    ...
    <div class="widget">
      ...
      <a href="recenth.php" class="continue-l"><h2>Recent History →</h2></a>
        ...
        while(1)
        {
            ...
            $q = "Select * from anime where id='".$rand1."';";
           $executequery = mysql_query($q) or die(mysql_error());
           while ($row = mysql_fetch_array($executequery)) {
              $a1N=$row['name']; 
           ...
           $q1= "Select * from anime where id='".$rand2."';";
           $executequery1 = mysql_query($q1) or die(mysql_error());
           while ($row = mysql_fetch_array($executequery1)) {
              $a2N=$row['name']; 
  ...
  <div class="conteudo">
   ...
   <ul class="caption-style-2">
			<li>
                            <img src="anim2.php?id=<?php echo $rand1?>" alt="" width="300" height="300">
				<div class="caption">
					<div class="blur"></div>
					<div class="caption-text">
						<h1>Anime 1</h1>
                                                <p><?php echo $a1N;?><br>
                                                    About: <?php echo $a1desp;?><a href="http://www.animefreak.tv/watch/anime-online"> Read more</a></p>
			...
			<li>
                            <img src="anim2.php?id=<?php echo $rand2?>" alt="" width="300" height="300">
				<div class="caption">
					<div class="blur"></div>
					<div class="caption-text">
						<h1>Anime 2</h1>
						<p><?php echo $a2N;?><br>
                                                    About: <?php echo $a2desp;?><a href="http://www.animefreak.tv/watch/anime-online"> Read more</a></p>
					</div>
				</div>
                        </li>
		</ul>
    ...
    <p style="clear: both;"></p>
        ...
        <form  action='' method='post'> 
            <input type="radio" name="anime" value="Anime1" checked>Anime 1 is better than Anime 2 
        <br>
            <input type="radio" name="anime" value="Anime2"> Anime 2 is better than Anime 1
        <br>
            <input type="radio" name="anime" value="Both"> Both Anime are same
        <br>
